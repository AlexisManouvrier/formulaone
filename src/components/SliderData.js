function SliderData(props) {
  const products = [
    ...
    },
    {
      ...
      text: "Une page se tourne pour le vétéran de la Formule 1, Kimi Raikkonen, l’arrêt de sa très longue carrière à compter de la fin de cette saison 2021.",
      long: "Lui qui est actuellement le dernier pilote à avoir été champion du monde au volant d’une Ferrari (c’était en 2007), pourrait poursuivre sa carrière dans le sport automobile et plus précisément, dans le championnat du monde des rallyes.",
